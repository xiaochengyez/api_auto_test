...
public class IdCardUtil {
    ...
    public static String getIdCard(){
        String SeventeenCode = randomLocationCode(RegisterLocationUtil.registerLocation()) + randomBirthday() + randomCode();
        String verificationCode = verificationCode(SeventeenCode);
        String idCard = SeventeenCode + verificationCode;
        return idCard;
    }
}
